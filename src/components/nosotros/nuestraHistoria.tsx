      ...
      <div className="container mx-auto px-4 md:px-2 ">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-[60%] h-[70%] z-20">
            <Image
              src="/nosotros/fabricacion_manos.jpg"
          ...
          >
            ...
            <div className="space-y-4 md:space-y-4 text-black leading-relaxed">
              <p className={`${raleway.className} text-[0.85rem] md:text-base lg:text-lg tracking-tight text-justify`}>
                Empieza el año 1991 cuando Heriberto Muñoz, después de trabajar 
                por años en las empresas líderes del rubro decide iniciar su 
                propia empresa con el sueño de crear prendas diferentes que 
                lleguen a diversas partes del mundo.
              </p>
              
              <p className={`${raleway.className} text-[0.85rem] md:text-base lg:text-lg tracking-tight text-justify`}>
                Empezó haciendo servicios de confección para grandes empresas 
                pero su amplio conocimiento en tejido de punto lo llevó a 
                incursionar en la producción de prendas completas.
              </p>
            </div>
          </motion.div>
