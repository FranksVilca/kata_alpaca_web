          ...
          >
            ...
            <div className="space-y-3 md:space-y-4 text-black leading-relaxed">
              <p className={`${raleway.className} text-[0.75rem] md:text-base tracking-tighter md:tracking-tight text-justify`}>
                Somos una empresa arequipeña con más de 33 años de experiencia 
                en el sector textil de alpaca. Iniciamos en 1991 ofreciendo 
                servicios a líderes de la industria, lo que nos permitió 
                perfeccionar técnicas de producción y altos estándares de calidad.
              </p>
              
              <p className={`${raleway.className} text-[0.75rem] md:text-base tracking-tighter md:tracking-tight text-justify`}>
                Con el tiempo lanzamos nuestra propia marca, trabajando en 
                equipo para innovar y mejorar continuamente nuestros procesos. 
                Desde 2002 exportamos a mercados internacionales como Estados 
                Unidos, Australia, Alemania, Reino Unido, Irlanda y Francia, 
                donde nuestros clientes nos reconocen por la excelencia y 
