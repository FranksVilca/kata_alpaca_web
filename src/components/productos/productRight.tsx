    ...
    <div id={id} className="bg-white">
      <div className="flex flex-col md:flex-row px-4 md:px-10">
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-6 md:py-0 order-2 md:order-1">
          ...
          <p className={`text-sm text-[#000] md:text-lg max-w-md text-center md:text-left px-10 md:px-0 ${raleway.className}`}>
            {text}
          </p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center min-h-[50vh] md:min-h-[85vh] py-6 md:py-0 order-1 md:order-2">
          <div className="relative">
            ...
            {/* Imagen de la Tela*/}
            <div className="absolute top-4/6 -translate-y-1/2 left-0 -translate-x-3/4 w-24 h-32 md:w-[154px] md:h-[211px] overflow-hidden z-10 transition-transform duration-300 ease-out hover:scale-120">
              <Image
                src={secondImage}
                alt="producto"
                fill
